...
export async function setup () {
  ...
  if (isInitialCreation) {
    ...
    await rootDrive.pda.writeFile(`/bookmarks/broxme.goto`, '', {metadata: {href: 'https://www.broxme.com/', title: 'BroxMe Technology'}})
    ...
    await rootDrive.pda.mkdir('/broxme')
    await rootDrive.pda.writeFile(`/broxme/pins.json`, JSON.stringify([
      
      'https://www.broxme.com/',
      'https://twitter.com/',
      'https://reddit.com/',
      'https://youtube.com/'
    ], null, 2))
