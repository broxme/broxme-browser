...
const INTERNAL_ORIGIN_REGEX = /^(broxme:)/i
const SITE_ORIGIN_REGEX = /^(broxme:|hyper:|https?:|data:)/i
...
export const setup = function () {
  ...
  rpc.exportAPI('broxme-browser', beakerBrowserManifest, beakerBrowserAPI, internalOnly)
