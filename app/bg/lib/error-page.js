  ...
  if (typeof e === 'object') {
    ...
    switch (e.errorCode) {
      ...
      case -501:
        ...
        info = `<p>Broxme Browser cannot establish a secure connection to the server for <strong>${origin}</strong>.</p>`
        icon = 'fa-close warning'
        button = '<a class="btn right" href="javascript:window.history.back()">Go back</a>'
        break
      case 504:
        icon = 'fa-share-alt'
        title = `Broxme Browser is unable to access this ${e.resource} right now.`
