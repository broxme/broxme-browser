...
export function setup () {
  ...
  tray.setToolTip('Broxme Browser')
...
async function buildMenu () {
  ...
  const contextMenu = Menu.buildFromTemplate([
    ...
    {type: 'separator'},
    {type: 'checkbox', label: 'Let Broxme Browser run in the background', checked: runBackground, click: () => onTogglePersist(!runBackground)},
    {label: 'Quit Broxme', click: () => app.quit()}
  ])
