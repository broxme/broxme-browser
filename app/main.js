...
protocol.registerSchemesAsPrivileged([
  ...
  {scheme: 'broxme', privileges: {standard: true, secure: true, allowServiceWorkers: true, supportFetchAPI: true, corsEnabled: true}}
])
...
app.on('ready', async function () {
  ...
  await logger.setup(join(commonOpts.userDataPath, 'broxme.log'))
  log.info('Welcome to Broxme Browser')
  ...
  adblocker.setup()
  //analytics.setup()  // disable analytics for now .
