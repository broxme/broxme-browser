...
export class EditBookmarkPopup extends BasePopup {
  constructor (bookmark) {
    ...
    if (bookmark && typeof broxme.bookmarks === 'undefined') {
      // NOTE
    ...
    return html`
      ...
      <form @submit=${this.onSubmit}>
        <div>
          ...
          <input required type="text" id="href-input" name="href" value="${this.bookmark?.href || ''}" placeholder="E.g. broxme.com" />

          <label for="title-input">Title</label>
          <input required type="text" id="title-input" name="title" value="${this.bookmark?.title || ''}" placeholder="E.g. Broxme Browser" />

          ${typeof broxme.bookmarks === 'undefined' ? '' : html`
  ...
  async onSubmit (e) {
    ...
    console.log(b)
    if (typeof broxme.bookmarks === 'undefined') {
      // userland
      b.href = normalizeUrl(b.href)
      let drive = broxme.hyperdrive.drive('hyper://private/')
      ...
      if (this.bookmark && b.href !== this.bookmark.href) {
        await broxme.bookmarks.remove(this.bookmark.href)
      }
      await broxme.bookmarks.add(b)
    }
