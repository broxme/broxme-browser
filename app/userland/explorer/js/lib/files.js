...
async function doCopyOrMove ({sourceItem, targetFolder}, op) {
  ...
  var sourceDrive = broxme.hyperdrive.drive(sourceItemParsed.hostname)
  let targetFolderParsed = new URL(targetFolder)
  var targetDrive = broxme.hyperdrive.drive(targetFolderParsed.hostname)
