import { LitElement, html, css } from 'broxme://app-stdlib/vendor/lit-element/lit-element.js'
...
class DriveView extends LitElement {
  ...
  constructor () {
    super()
    this.drive = broxme.hyperdrive.drive(location)
    this.info = undefined
    this.entries = []
    this.load()
  }
  ...
  async onClickEditProperties (e) {
    e.preventDefault()
    await broxme.shell.drivePropertiesDialog(location.origin)
    this.load()
  }
