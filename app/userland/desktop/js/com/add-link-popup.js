/* globals beaker */
import { html, css } from 'broxme://app-stdlib/vendor/lit-element/lit-element.js'
import { repeat } from 'broxme://app-stdlib/vendor/lit-element/lit-html/directives/repeat.js'
import { BasePopup } from 'broxme://app-stdlib/js/com/popups/base.js'
import buttonsCSS from 'broxme://app-stdlib/css/buttons2.css.js'
import popupsCSS from 'broxme://app-stdlib/css/com/popups.css.js'
...
import { toNiceUrl, normalizeUrl } from 'broxme://app-stdlib/js/strings.js'
...
export class AddLinkPopup extends BasePopup {
  ...
  async runQuery () {
    this.reset()
    this.history = await (this.query ? broxme.history.search(this.query) : broxme.history.getVisitHistory(0))
    if (this.query) {
  ...
  onContextMenuHistory (e) {
    ...
    contextMenu.create({x: e.clientX, y: e.clientY, items, fontAwesomeCSSUrl: 'broxme://assets/font-awesome.css'})
  }
}
