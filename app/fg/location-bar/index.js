...
const bg = {
  beakerBrowser: rpc.importAPI('broxme-browser', browserManifest),
  ...
  render () {
    const searchLink = (label, url) => {
      return html`
        ...
        >
          <img src="broxme://assets/search-engines/${label.toLowerCase()}.png">
        </a>
      `
    }
    ...
    return html`
      ...
      <div class="wrapper">
        ...
        <div class="search-engines">
          ...
          <div class="list">
            ${searchLink('broxme', `broxme://desktop/?q=${encodeURIComponent(this.query)}`)}
