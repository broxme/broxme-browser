...
class SetupModal extends LitElement {
  ...
  renderStage1 () {
    return html`
      ...
      <div class="wrapper">
        <div class="intro">
          <img class="intro-logo" src="broxme://assets/logo">
          <h1 class="intro-title">Welcome to Broxme Browser</h1>
          <p class="intro-text">
  ...
  renderStage2 () {
    return html`
      ...
      <div class="wrapper">
        <div class="intro">
          <h1 class="intro-title" style="margin: 10px 0 30px; font-size: 52px;">What can Broxme Browser do?</h1>
